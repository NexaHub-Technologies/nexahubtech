...
const AUDIENCE = [
	{
		...
		d: "Across Nigeria and Africa, who want a clear, structured path into web development — taught by people who build for a living.",
	},
	{
		t: "Founders & businesses",
		d: "Who need a software partner that understands the problem first and builds something dependable, wherever you are in the world.",
	},
	{
		t: "Our graduates",
		d: "Who keep growing with us — moving from the classroom onto real projects, and from learning skills to delivering them.",
	},
];
